    ...
    <article className="mx-auto max-w-[800px]">
      ...
      <header className="mb-6">
        ...
        <div className="mt-4 flex flex-wrap items-center gap-2.5 text-sm">
          ...
          {approvalCount >= 2 && (
            <span className="group/tip relative inline-flex items-center gap-1 rounded-full bg-green-100 px-2 py-0.5 text-[11px] font-semibold text-green-700 dark:bg-green-950 dark:text-green-400">
